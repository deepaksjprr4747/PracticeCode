...
public class TC05_EditedGLAllocationValidationMonthView extends BaseTest{
	...
	public void plTabExpand() throws InterruptedException, FileNotFoundException, IOException
	{
		...
		for (String[] arrays : r) {
			...
			String glAllocationValue = arrays[17];
			...
			plForecast.selectFiltercriteria("SB6","Forecast"); 		//Pass selectFiltercriteria("OrgName") to select manual Org
