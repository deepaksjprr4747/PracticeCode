...
public class TC01_PLForecastBetaScreenQuarterView extends BaseTest{
	...
	{
		try{
			Log.info("Starting PL Forecast Beta screen expansion on Quarter View");
			...
			plForecastBeta.timePeriodFilter("Quarter");
			Log.info("Starting dates selection");
			plForecastBeta.timePeriodQuarterView(fromMonth, fromYear, Constants.cashAndPLPageFromInputBox);
			plForecastBeta.timePeriodQuarterView(toMonth, toYear-1, Constants.cashAndPLPageToInputBox);
