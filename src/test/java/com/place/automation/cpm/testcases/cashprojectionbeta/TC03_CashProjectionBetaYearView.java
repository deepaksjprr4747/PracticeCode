...
public class TC03_CashProjectionBetaYearView extends BaseTest{
	@BeforeTest
	...
	public void cashProjectionYearExpansion(String startDate, String endDate) throws Exception
	{
		try{
			...
			plForecast.cashFilters(startDate, endDate,"All Organizations",  "Actuals to Date & Forecast","Year");
