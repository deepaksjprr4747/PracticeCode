...
public class TC02_CashProjectionBetaQuarterView extends BaseTest{
	@BeforeTest
	...
	public void cashProjectionQuarterExpansion(String startDate, String endDate) throws Exception
	{
		try{
			homePage.searchInLauncher("Cash Projection (Beta)");
			minWait();
			
			Log.info("Starting Cash Projection  Beta screen expansion on Quarter View");
			Log.info("Starting filter selection");
			plForecast.cashFilters(startDate, endDate,"All Organizations",  "Actuals to Date & Forecast","Quarter");
