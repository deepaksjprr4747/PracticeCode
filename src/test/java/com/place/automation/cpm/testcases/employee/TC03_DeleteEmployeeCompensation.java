...
public class TC03_DeleteEmployeeCompensation extends BaseTest{
	int Loop =0;
	int loopcount= 0;
	Object d1[][];
			...
			minWait();
	        	 ...
	        	 homePage.searchInLauncher("Employees");
	  			extreporting("Navigating to Employees page", "Redirected to Employee page successfully", "Pass");
		 			...
		 			employee.deleteCompensation();
		  			extreporting("Deleting Employee Compensation record", "Deleted Employee compensation record successfully", "Pass");
