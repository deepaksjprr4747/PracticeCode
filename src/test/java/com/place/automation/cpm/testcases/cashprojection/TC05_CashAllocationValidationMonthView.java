...
public class TC05_CashAllocationValidationMonthView extends BaseTest{
	...
	public void plTabExpand() throws InterruptedException, FileNotFoundException, IOException
	{
		...
		for (String[] arrays : r) {
			...
			String cashAllocationValue = arrays[7];
			String revBillingCycle = arrays[5];
			String expEDType = arrays[8];
			String cashCount = arrays[10];
			String edPayTerm = arrays[4];
