...
public class TC04_CashProjectionBetaWeekView extends BaseTest{
	@BeforeTest
	...
	public void cashProjectionWeekExpansion(String startDate, String endDate) throws Exception
	{
		try{
			...
			plForecast.cashFilters(startDate, endDate,"All Organizations",  "Actuals to Date & Forecast","Week");
